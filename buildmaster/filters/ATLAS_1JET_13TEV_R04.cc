...
and the absolute jet rapidity up to |y| = 3. The double-differential dijet production cross-sections are presented as a function of the dijet mass, covering the range from 300 GeV to 9 TeV,
and the half absolute rapidity separation between the two leading jets within |y| < 3, y∗∗, up to y∗∗ = 3. 
...
*/
#include "ATLAS_1JET_13TEV_R04.h"

void ATLAS_1JET_13TEV_R04Filter::ReadData()
{
  ...
  std::vector<int> ndata  = {33, 32, 31, 31, 28, 22};    
